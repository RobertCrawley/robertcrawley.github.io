...
document.querySelector("#btn_menu_five").addEventListener("click", closeMenuFive);
...
document.querySelector("#HTML-Content").addEventListener("click", closeMenuFive);
...
function closeMenuFive() {
    const detail = document.querySelector("#details_five");
    detail.removeAttribute("open");
}
